...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAVMNZAQNVHW7QH6HE',
            secretKey: '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',
            sessionToken: '',
            region: '',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://y9iyt5siig.execute-api.us-west-2.amazonaws.com/test';
